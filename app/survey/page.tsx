...
export const dynamic = "force-dynamic"; // ✅ config de Next (string)
export const revalidate = 0;

import NextDynamic from "next/dynamic";
import { useState, useMemo } from "react";
// ⬇️ QUITA estos imports de nivel superior para evitar que Firestore se evalúe en el server
...
function SurveyForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Importa Firestore y tu config SOLO cuando se necesita
...
// ⬇️ Exporta la página como client-only (no SSR en absoluto)
export default NextDynamic(() => Promise.resolve(SurveyForm), { ssr: false });
